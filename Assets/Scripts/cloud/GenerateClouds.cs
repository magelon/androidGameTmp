...
public class GenerateClouds : MonoBehaviour
{
    ...
    //Cloud Data
    //how big all clouds area
    public float cloudSize = 5;
    //size of each pice of cloud
    ...
    private void AddCloud(List<CloudData> currBatch, int x, int y)
    {
        ...
        Vector3 position = new Vector3(transform.position.x + x * cloudSize, transform.position.y+y*cloudSize, transform.position.z);
