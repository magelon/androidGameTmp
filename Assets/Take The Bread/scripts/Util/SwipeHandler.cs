...
using UnityEngine.UI;
		...
		public class SwipeHandler : MonoBehaviour
		{
				...
				void Start(){
                        ...
                        shopMenu= GameObject.Find("Canvas").GetComponent<ShopMenu>();
    }
				...
				private void HandleMobileSwipe ()
				{
                    ...
                    if (shopMenu)
                    {
                        shopMenu.move((-l * 200f));

                        shopMenu.debugtext(l.ToString());
                    }
										}
...
//										if (SW) {			
                                                ...
                                                if (shopMenu) shopMenu.swipePage(force);
...
//										}
        ...
        if (handleSwipes && Input.GetMouseButton(0) && mouseMove != 0)
        {
            ...
            if (levelMenu) { 
            levelMenu.move((mouseMove * 10f));
            LevelMenu.islock = true;
                }
            if (shopMenu)
            {
                shopMenu.move((mouseMove*10f));
                ShopMenu.islock = true;
            }
